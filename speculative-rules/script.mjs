...
if (document.prerendering || performance.getEntriesByType('navigation')[0].activationStart > 0 || performance.getEntriesByType('navigation')[0].type == 'reload') {
